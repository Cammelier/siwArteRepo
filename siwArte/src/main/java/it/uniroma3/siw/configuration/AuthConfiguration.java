...
public class AuthConfiguration {
    ...
    protected SecurityFilterChain configure(final HttpSecurity httpSecurity) throws Exception {
        httpSecurity
            ...
            .requestMatchers(HttpMethod.GET, "/", "/login", "/index", "/opere", "/artisti", "/register", "/css/**", "/images/**","/static/uploads/**", "/uploads/**", "/favicon.ico", "/dettagliArt/**", "/dettagliOpera/**","/dettagliCur/**").permitAll()
